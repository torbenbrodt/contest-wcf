 ...
 */
class ContestEntrySolutionList extends DatabaseObjectList {
	/**
	 * list of solutions
	 * 
	 * @var array<ViewableContestEntrySolution>
	 */
	...
	public function readObjects() {
		...
		while ($row = WCF::getDB()->fetchArray($result)) {
			$this->solutions[] = new ViewableContestEntrySolution(null, $row);
		}
	}
