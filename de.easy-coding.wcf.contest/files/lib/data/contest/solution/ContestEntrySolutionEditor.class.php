<?php
// wcf imports
require_once(WCF_DIR.'lib/data/contest/solution/ContestEntrySolution.class.php');
 ...
 */
class ContestEntrySolutionEditor extends ContestEntrySolution {
	/**
	...
	public static function create($contestID, $solution, $userID, $username, $time = TIME_NOW) {
		...
		return new ContestEntrySolutionEditor($solutionID);
	}
