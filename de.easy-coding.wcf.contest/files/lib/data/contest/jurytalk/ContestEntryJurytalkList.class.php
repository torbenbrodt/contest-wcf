...
require_once(WCF_DIR.'lib/data/contest/jurytalk/ViewableContestEntryJury.class.php');
 ...
 */
class ContestEntryJuryList extends DatabaseObjectList {
	/**
	 * list of jurytalks
	 * 
	 * @var array<ViewableContestEntryJury>
	 */
	...
	public function readObjects() {
		...
		while ($row = WCF::getDB()->fetchArray($result)) {
			$this->jurytalks[] = new ViewableContestEntryJury(null, $row);
		}
	}
