<?php
// wcf imports
require_once(WCF_DIR.'lib/data/contest/comment/ContestEntryComment.class.php');
 ...
 */
class ContestEntryCommentEditor extends ContestEntryComment {
	/**
	...
	public static function create($contestID, $comment, $userID, $username, $time = TIME_NOW) {
		...
		return new ContestEntryCommentEditor($commentID);
	}
