								...
								<div class="messageFooter">
									<div class="smallButtons">
										<ul>
											...
											{if $entry->isEnabledSolution()}
											<li><a href="index.php?page=ContestSolution&amp;contestID={@$entry->contestID}{@SID_ARG_2ND}#solutions" title="{lang}wcf.contest.numberOfSolutions{/lang}"><img src="{icon}contestSolutionS.png{/icon}" alt="" /> <span>{lang}wcf.contest.numberOfSolutions{/lang}</span></a></li>{/if}
											...
											{if $entry->isEnabledJury()}
											<li><a href="index.php?page=ContestJury&amp;contestID={@$entry->contestID}{@SID_ARG_2ND}#jurys" title="{lang}wcf.contest.numberOfJurys{/lang}"><img src="{icon}contestJuryS.png{/icon}" alt="" /> <span>{lang}wcf.contest.numberOfJurys{/lang}</span></a></li>{/if}
