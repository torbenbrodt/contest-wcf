...
<div id="main">
	...
	<form method="post" id="ContestAddForm" enctype="multipart/form-data" action="index.php?form=ContestEntry{@$action|ucfirst}{if $action == 'add'}&amp;userID={@$userID}{elseif $action == 'edit'}&amp;contestID={@$contestID}{/if}">
