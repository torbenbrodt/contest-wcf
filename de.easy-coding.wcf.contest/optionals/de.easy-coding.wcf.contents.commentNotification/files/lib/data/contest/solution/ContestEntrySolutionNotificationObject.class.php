...
require_once(WCF_DIR.'lib/data/contest/solution/ViewableContestEntrySolution.class.php');
 ...
 */
class ContestEntrySolutionNotificationObject extends ViewableContestEntrySolution implements NotificationObject {

	/**
	 * @see ViewableContestEntrySolution:__construct
	 */
	...
	public function getURL() {
		return 'index.php?page=ContestEntry&contestID='.$this->contestID.'&solutionID='.$this->solutionID.'#solution'.$this->solutionID;
	}
	...
	/**
	 * @see ViewableContestEntrySolution::getFormattedSolution()
	 */
