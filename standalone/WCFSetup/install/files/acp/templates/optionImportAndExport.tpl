...
<form method="post" action="index.php?form=OptionImportAndExport" enctype="multipart/form-data">
	...
	<div class="container-1">
		<fieldset>
			...
			<div class="formElement" id="optionExportDiv">
				<div class="formField">
					<a href="index.php?action=OptionExport&amp;packageID={@PACKAGE_ID}{@SID_ARG_2ND}" id="optionExport">{lang}wcf.acp.option.export.download{/lang}</a>
				</div>
