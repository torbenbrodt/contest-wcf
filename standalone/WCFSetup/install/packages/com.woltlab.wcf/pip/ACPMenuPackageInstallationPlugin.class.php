 ...
 */
class ACPMenuPackageInstallationPlugin extends AbstractXMLPackageInstallationPlugin {
	public $tagName = 'acpmenu';
			...
			if (count($block['children'])) {
				...
				if ($block['name'] == 'import') {
					...
					foreach ($block['children'] as $acpMenuItem) {
						...
						if (!empty($acpMenuItem['showorder'])) $showOrder = intval($acpMenuItem['showorder']);
