...
<head>
	<title>{lang}wcf.search.title{/lang} - {PAGE_TITLE}</title>
			...
			<div class="container-1">
				<fieldset>
						...
						<div class="formGroupField">
							<fieldset id="searchPeriod">
								...
								<div class="floatedElement">
									...
									<div class="floatedElement">
										<a id="fromButton"><img src="{@RELATIVE_WCF_DIR}icon/calendarOptionsM.png" alt="" /></a>
								...
								<div class="floatedElement">
									...
									<div class="floatedElement">
										<a id="untilButton"><img src="{@RELATIVE_WCF_DIR}icon/calendarOptionsM.png" alt="" /></a>
					...
					<div class="formGroup">
						...
						<div class="formGroupField">
							<fieldset>
								<legend><label for="sortField">{lang}wcf.search.sortBy{/lang}</label></legend>
								<div class="formField">
