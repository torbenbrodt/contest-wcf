...
class CONTESTCore extends WCF implements PageMenuContainer, UserCPMenuContainer, UserProfileMenuContainer {
	...
	protected function initTPL() {
		...
		// check offline mode
		if (OFFLINE && !self::getUser()->getPermission('user.contest.canViewCONTESTOffline')) {
	...
	protected function initSession() {
		require_once(CONTEST_DIR.'lib/system/session/CONTESTSessionFactory.class.php');
		$factory = new CONTESTSessionFactory();
	...
	protected function assignDefaultTemplateVariables() {
		...
		self::getTPL()->assign(array(
			'timezone' => DateUtil::getTimezone(),			'stylePickerOptions' => (SHOW_STYLE_CHOOSER ? StyleManager::getAvailableStyles() : array())));
	}
}
?>
